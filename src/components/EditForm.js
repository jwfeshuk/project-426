                    ...
                    <Form>
                        ...
                        <Form.Row>
                            ...
                            <Form.Group as={Col}>
                                ...
                                <Form.Group controlId="diff" onChange={e => this.setState({rating: e.target.value})}>
                            ...
                            <Form.Group as={Col} controlId="finalGrade">
                                <Form.Label>What was your final grade?</Form.Label>
                                <Form.Control as="select" defaultValue="Prefer Not To Say" onChange={e => this.setState({first: e.target.value})}>
                                    <option>A</option>
                                    <option>A-</option>
                                    <option>B+</option>
                                    <option>B</option>
                        ...
                        <Form.Row>
                            <Form.Group as={Col}>
                                ...
                                <Form.Group controlId="again" onChange={e => this.setState({rating: e.target.value})}>
                            ...
                            <Form.Group as={Col}>
                                <Form.Label>Was attendance required?</Form.Label>
                                <Form.Group controlId="attendance" onChange={e => this.setState({rating: e.target.value})}>
                            ...
                            <Form.Group as={Col}>
                                ...
                                <Form.Group controlId="textbook" onChange={e => this.setState({rating: e.target.value})}>
                        ...
                        <Form.Row>
                            <Form.Group as={Col}>
                                <Form.Label>Which of these best describes the professor?</Form.Label>
                                    <Form.Group controlId="tags" onChange={e => this.setState({rating: e.target.value})}>
                        ...
                        <Form.Control as="textarea" onChange={e => this.setState({first: e.target.value})}/>
